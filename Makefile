...
EXTRA_DIST = owa_browse3.make rules.make configure Makefile.include /usr/lib/mono/gtk-sharp-3.0/atk-sharp.dll /usr/lib/mono/gtk-sharp-3.0/gdk-sharp.dll /usr/lib/mono/gtk-sharp-3.0/gtk-sharp.dll /usr/lib/mono/gtk-sharp-3.0/pango-sharp.dll /usr/lib/mono/gtk-sharp-3.0/glib-sharp.dll
